...
public class SearchBlockController {
    ...
    private void initialize() {
        try {
            ...
            SplitPane SplitTop = finderActionInterface.load(this.getClass().getResource(Resources.FXMLSearchParameters + "search_parameters.fxml"), new SearchParametersController(this.finderActionInterface));

            // Loading BOTTOM part of interface.
            SplitPane SplitBottom = finderActionInterface.load(this.getClass().getResource(Resources.FXMLSearchResult + "search_result.fxml"), new SearchResultController(this.finderActionInterface));
