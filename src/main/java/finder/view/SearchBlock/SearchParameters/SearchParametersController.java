...
public class SearchParametersController {
    ...
    private void initialize() {
        try {
            ...
            // Search text area.
            TextArea textArea = finderActionInterface.load(this.getClass().getResource(Resources.FXMLSearchParameters + "text_area.fxml"), new TextAreaController(this.finderActionInterface));
            // Search options block.
            AnchorPane searchOptionsBlock = finderActionInterface.load(this.getClass().getResource(Resources.FXMLSearchParameters + "search_options_block.fxml"), new SearchOptionsController(this.finderActionInterface));
